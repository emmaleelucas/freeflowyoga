...
async function UpcomingClassesPreview() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {previewClasses.map((yogaClass) => (
        <Link key={yogaClass.id} href={`/schedule?classId=${yogaClass.id}`}>
          <Card
            className="border-2 hover:border-[#644874]/40 dark:hover:border-[#644874]/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 cursor-pointer h-full bg-white/80 dark:bg-background/80 backdrop-blur-sm"
          >
            <CardContent className="p-5">
...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      {/* Benefits Section */}
      <section className="pb-20 md:pb-28 relative -mt-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Card className="border-2 hover:border-[#644874]/40 dark:hover:border-[#644874]/50 transition-all duration-500 hover:shadow-xl hover:-translate-y-2 group animate-on-scroll opacity-0 translate-y-8">
              <CardContent className="pt-6 space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#644874]/10 to-[#644874]/20 dark:from-[#644874]/30 dark:to-[#644874]/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                    <Calendar className="h-6 w-6 text-[#644874] dark:text-[#9d7fb0]" />
                  </div>
            ...
            <Card className="border-2 hover:border-[#6B92B5]/40 dark:hover:border-[#6B92B5]/50 transition-all duration-500 hover:shadow-xl hover:-translate-y-2 group animate-on-scroll opacity-0 translate-y-8 delay-100">
              <CardContent className="pt-6 space-y-3">
                <div className="flex items-center gap-3">
            ...
            <Card className="border-2 hover:border-[#644874]/40 dark:hover:border-[#644874]/50 transition-all duration-500 hover:shadow-xl hover:-translate-y-2 group animate-on-scroll opacity-0 translate-y-8 delay-200">
              <CardContent className="pt-6 space-y-3">
                <div className="flex items-center gap-3">
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center justify-between mb-8 animate-on-scroll opacity-0 translate-y-8">
              <div>
