              ...
              <div className="flex gap-5 items-center">
                <Link href={"/"} className="flex items-center gap-2 font-semibold group">
                  <div className="relative">
                    <Image src="/images/logo-light-theme.png" alt="K-State Free Yoga Logo" width={32} height={32} className="dark:hidden transition-transform group-hover:scale-110" />
                    <Image src="/images/logo-dark-theme.png" alt="K-State Free Yoga Logo" width={32} height={32} className="hidden dark:block transition-transform group-hover:scale-110" />
                  </div>
